...
def show_message():
    ...
    return render_template('test_endpoints_page.html', test_result_string=f'text_string("{text_to_show}", scroll_speed={scroll_speed})!')  
...
def show_letter():
    ...
    return render_template('test_endpoints_page.html', test_result_string=f'show_letter({letter_to_show}, text_colour={text_colour}, back_colour={back_colour})')  
...
def low_light():
    ...
    return render_template('test_endpoints_page.html', test_result_string=f'low_light = {low_light_val}')  
...
def set_rotation():
    ...
    return render_template('test_endpoints_page.html', test_result_string=f'set_rotation({r}, redraw={redraw})!')    
