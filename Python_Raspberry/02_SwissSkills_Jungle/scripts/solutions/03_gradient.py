...
# ------------------------------------------------------------------
# Name  : 03_gradient.py
# Source: https://raw.githubusercontent.com/walter-rothlin/RaspberryPi4PiPlates/master/Python_Raspberry/02_SwissSkills_Jungle/scripts/solutions/03_gradient.py
#
